...
export enum TriggerType {
  ...
  CONFIRM_INSPECTION_AVAILABLE_STANDARD = 'CONFIRM_INSPECTION_AVAILABLE_STANDARD',
  CONFIRM_INSPECTION_AVAILABLE_PACKAGED_LOCAL = 'CONFIRM_INSPECTION_AVAILABLE_PACKAGED_LOCAL',
  FINALIZE_AFTER_INSPECTION_ACCEPTANCE = 'FINALIZE_AFTER_INSPECTION_ACCEPTANCE',
