locals {
  gateway_environment = [
    ...
    { name = "GATEWAY_GASLESS_COMMAND_LEASE_MS", value = "30000" },
    { name = "GATEWAY_GASLESS_COMMAND_MAX_ATTEMPTS", value = "5" },
    { name = "GATEWAY_GASLESS_COMMAND_MAX_BATCH", value = "25" },
    { name = "GATEWAY_GASLESS_COMMAND_MAX_PENDING", value = "100" },
    { name = "GATEWAY_GASLESS_COMMAND_POLL_INTERVAL_MS", value = "1000" },
    { name = "GATEWAY_GASLESS_COMMAND_RETRY_INITIAL_MS", value = "1000" },
    { name = "GATEWAY_GASLESS_COMMAND_RETRY_MAX_MS", value = "30000" },
    { name = "GATEWAY_GASLESS_COMMAND_WAIT_TIMEOUT_MS", value = "15000" },
