...
| Mainnet contract deployment/verify   | `prepare:base-mainnet`, hardware-wallet broadcast, `finalize:base-mainnet` | `docs/runbooks/base-mainnet-go-no-go.md`                                              | Request, deployment tx, verify output, chain ID, contract address | Engineering Lead, Ops Lead                                     |
...
| Delegated executor governance action | **Blocked: no supported runtime or command exists**                        | `docs/runbooks/gateway-governance-signer-custody.md`                                  | Implementation acceptance before any execution evidence           | Service Owner plus peer reviewer                               |
