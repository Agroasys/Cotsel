...
| Delegated executor governance action | `pnpm --filter ./gateway run execute:governance-action -- <actionId>` | `docs/runbooks/gateway-governance-signer-custody.md`                                  | Executor session window, signer custody source, tx hash       | Service Owner plus peer reviewer                               |
