...
| PolkaVM deployment verification + smoke checks | A | Backlog | 0 | #64, #139 | CI exists but no deployment-verification artifact workflow; ADR gate #138 captured compile proof and deploy blocker evidence | No deterministic deploy verification bundle and smoke automation; testnet deploy evidence blocked by unfunded deploy key |
