...
## Act 2 — Lock: Buyer Deposits Funds into Escrow
...
### Step 2.1 — Buyer creates trade (SDK call)
...
## Act 3 — Stage 1 Release: Oracle Verifies Documentation
...
### Step 3.1 — Oracle triggers Stage 1 release
...
### Step 3.2 — Operator reviews and approves (Manual Approval Mode)
...
### Step 3.3 — Verify on-chain disbursement
...
## Act 4 — Arrival Confirmation: Quality Verified at Destination
...
### Step 4.1 — Oracle triggers arrival confirmation
...
## Act 5 — Final Settlement: Dispute Window Elapses
...
### Step 5.1 — Finalize after dispute window
...
## Act 6 — Reconciliation: On-Chain vs. Off-Chain Integrity Check
...
## Act 7 — Dispute Path (Extended Demo)
