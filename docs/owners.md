...
| Gateway                    | `gateway/`, `docs/api/cotsel-dashboard-gateway.openapi.yml`, `docs/api/cotsel-dashboard-gateway/`, gateway runbooks | Gateway/platform owner         | Downstream service owner for changed service contracts                           | `area:gateway`, `type:integration`                   |
