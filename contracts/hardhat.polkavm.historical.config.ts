 ...
 *
 * Historical-only Hardhat config for archived PolkaVM validation paths.
 * Do not use this file for active Base v1 development or release work.
 */
...
const config: HardhatUserConfig & { resolc: unknown } = {
  solidity: {
    version: "0.8.28",
    settings: {
      viaIR: true,
