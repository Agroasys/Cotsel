...
function makeEntry(id: number): LedgerEntryWithState {
  return {
    ...
    log_index: 0,
    log_address: `0x${'11'.repeat(20)}`,
    log_identity_hash: 'a'.repeat(64),
    canonicality_state: 'CANONICAL',
    canonicality_verified_at: new Date('2026-03-31T00:00:00.000Z'),
    canonicality_observed_block_hash: `0x${'ab'.repeat(32)}`,
    canonicality_depth: null,
    canonicality_stable_block_number: 100,
      ...
      new Map([
        [
          11,
          {
            ...
            reconciliationCoverageToBlock: 1_000_000,
            reconciliationCoverageComplete: true,
            canonicalityState: 'CANONICAL',
            canonicalityDepth: null,
            canonicalityStableBlockNumber: 100,
